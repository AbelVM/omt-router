...
const LOCALES = {
  en: {
    ...
    togglePointMode: 'Toggle which point to set (origin/destination)',
    nextPoint: 'Next: Origin',
  ...
  es: {
    ...
    rightClick: 'Clic der.',
    tap: 'Toca',
    longPress: 'Presiona largo',
    setOrigin: 'fijar origen',
    setDestination: 'fijar destino',
    togglePointMode: 'Alterna qué punto establecer (origen/destino)',
    nextPoint: 'Siguiente: Origen',
  ...
  ca: {
    ...
    tap: 'Toca',
    longPress: 'Pressió llarga',
    setOrigin: 'fixa origen',
    setDestination: 'fixa destí',
    togglePointMode: 'Alterna quin punt fixar (origen/destí)',
    nextPoint: 'Següent: Origen',
  ...
  gl: {
    ...
    rightClick: 'Clic der.',
    tap: 'Toca',
    longPress: 'Presión longa',
    setOrigin: 'fijar orixe',
    setDestination: 'fijar destino',
    togglePointMode: 'Alterna qué punto fixar (orixe/destino)',
    nextPoint: 'Seguinte: Orixe',
  ...
  eu: {
    ...
    tap: 'Sakatu',
    longPress: 'Sakatu luzea',
    setOrigin: 'jatorria ezarri',
    setDestination: 'helmuga ezarri',
    togglePointMode: 'Ezarri nahi duzun helmuga aldatu (jatorria/helmuga)',
    nextPoint: 'Hurrengoa: Jatorria',
  ...
  fr: {
    ...
    togglePointMode: 'Basculer entre les points (origine/destination)',
    nextPoint: 'Suivant : Origine',
  ...
  de: {
    ...
    tap: 'Tippen',
    longPress: 'Gedrückt halten',
    setOrigin: 'Start setzen',
    setDestination: 'Ziel setzen',
    togglePointMode: 'Umschalten, welcher Punkt gesetzt wird (Start/Ziel)',
    nextPoint: 'Nächster: Start',
  ...
  ru: {
    ...
    setDestination: 'установить конец',
    togglePointMode: 'Переключение между точками (начало/конец)',
    nextPoint: 'Далее: Начало',
  ...
  ja: {
    ...
    togglePointMode: 'ポイントの設定を切り替え（出発点/目的地）',
    nextPoint: '次: 出発点',
