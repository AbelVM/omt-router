...
function Ps(e, t = []) {
	...
	let i = Array.from(n.isobands(e)).filter((e) => Array.isArray(e.coordinates) && e.coordinates.length > 0 && (r > 0 ? e.valueMax <= r : !0)), a = js(e.map((e) => [e[0], e[1]]));
	if (!i || i.length === 0) {
		let n = e.map((e) => [e[0], e[1]]), r = null;
		if (Array.isArray(a) && a.length >= 4) r = a.slice();
		else if (n.length >= 2) {
	...
	return {
		...
		features: i.map((e, t) => {
			...
			i.sort((e, t) => t.area - e.area);
			function o(e, t) {
				return e.minX <= t.minX && e.minY <= t.minY && e.maxX >= t.maxX && e.maxY >= t.maxY;
			}
			for (let e = 0; e < i.length; e++) {
				let t = i[e], n = Ds(t.ring) || t.ring[0], r = null, a = Infinity;
				for (let s = 0; s < i.length; s++) {
					if (e === s) continue;
					let c = i[s];
					c.area <= t.area || o(c.bbox, t.bbox) && Es(n, c.ring) && c.area < a && (a = c.area, r = c);
				}
			...
			let u = [];
			for (let e of i) if (!(s(e) & 1)) {
				let t = [c(e.ring)];
				for (let n of e.children) (s(n) & 1) == 1 && t.push(l(n.ring));
				u.push(t);
			}
			return {
				type: "Feature",
...
async function Fs({ point: e, direction: t = "from", mode: n = "car", costField: r = "distance", graph: i, maxCost: a = 1e3, snapMaxDistM: o = 800, penalties: s = {} } = {}) {
	...
	let h = d.coordsArr || [], g = [], _ = _e(0, a, 7).filter((e) => e < a);
	_.push(a), _.sort((e, t) => e - t);
	for (let e = 0; e < f.length; e++) {
		let t = f[e];
		if (!Number.isFinite(t) || t > a * 1.5) continue;
		let n = h[e];
		!n || n.length < 2 || g.push([
			n[0],
			n[1],
	...
	return m && (console.error("DEBUG_ISOLINES isoline points", g.length, g), console.error("DEBUG_ISOLINES breaks", _)), g.length === 0 ? {
		type: "FeatureCollection",
		features: []
	} : Ps(g, _);
}
