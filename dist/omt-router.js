...
function ro(e) {
	...
	if (e instanceof Da || (e = Ga(e)), !e) return new ao();
	if (e instanceof ao) return e;
	e = e.rgb();
	var t = e.r / 255, n = e.g / 255, r = e.b / 255, i = Math.min(t, n, r), a = Math.max(t, n, r), o = NaN, s = a - i, c = (a + i) / 2;
	return s ? (o = t === a ? (n - r) / s + (n < r) * 6 : n === a ? (r - t) / s + 2 : (t - n) / s + 4, s /= c < .5 ? a + i : 2 - a - i, o *= 60) : s = c > 0 && c < 1 ? 0 : o, new ao(o, s, c, e.opacity);
}
function io(e, t, n, r) {
	return arguments.length === 1 ? ro(e) : new ao(e, t, n, r ?? 1);
}
function ao(e, t, n, r) {
...
Ta(ao, io, Ea(Da, {
	brighter(e) {
		return e = e == null ? ka : ka ** +e, new ao(this.h, this.s, this.l * e, this.opacity);
	},
	darker(e) {
		return e = e == null ? Oa : Oa ** +e, new ao(this.h, this.s, this.l * e, this.opacity);
	},
	rgb() {
	...
	clamp() {
		return new ao(oo(this.h), so(this.s), so(this.l), $a(this.opacity));
	},
	displayable() {
	...
	formatHsl() {
		let e = $a(this.opacity);
		return `${e === 1 ? "hsl(" : "hsla("}${oo(this.h)}, ${so(this.s) * 100}%, ${so(this.l) * 100}%${e === 1 ? ")" : `, ${e})`}`;
	}
}));
function oo(e) {
...
function po(e) {
	return (e = +e) == 1 ? mo : function(t, n) {
		return n - t ? fo(t, n, e) : lo(isNaN(t) ? n : t);
	};
}
function mo(e, t) {
	var n = t - e;
	return n ? uo(e, n) : lo(isNaN(e) ? t : e);
}
//#endregion
...
var ho = (function e(t) {
	var n = po(t);
	function r(e, t) {
		var r = n((e = Ya(e)).r, (t = Ya(t)).r), i = n(e.g, t.g), a = n(e.b, t.b), o = mo(e.opacity, t.opacity);
		return function(t) {
...
function xo(e, t) {
	var n = {}, r = {}, i;
	for (i in (typeof e != "object" || !e) && (e = {}), (typeof t != "object" || !t) && (t = {}), t) i in e ? n[i] = Do(e[i], t[i]) : r[i] = t[i];
	return function(e) {
...
var So = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, Co = new RegExp(So.source, "g");
function wo(e) {
	return function() {
		return e;
	};
...
function Eo(e, t) {
	var n = So.lastIndex = Co.lastIndex = 0, r, i, a, o = -1, s = [], c = [];
	for (e += "", t += ""; (r = So.exec(e)) && (i = Co.exec(t));) (a = i.index) > n && (a = t.slice(n, a), s[o] ? s[o] += a : s[++o] = a), (r = r[0]) === (i = i[0]) ? s[o] ? s[o] += i : s[++o] = i : (s[++o] = null, c.push({
		i: o,
		x: bo(r, i)
	})), n = Co.lastIndex;
	return n < t.length && (a = t.slice(n), s[o] ? s[o] += a : s[++o] = a), s.length < 2 ? c[0] ? To(c[0].x) : wo(t) : (t = c.length, function(e) {
...
function Do(e, t) {
	var n = typeof t, r;
	return t == null || n === "boolean" ? lo(t) : (n === "number" ? bo : n === "string" ? (r = Ga(t)) ? (t = r, ho) : Eo : t instanceof Ga ? ho : t instanceof Date ? yo : _o(t) ? go : Array.isArray(t) ? vo : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? xo : bo)(e, t);
}
//#endregion
...
function Fo(e, t, n) {
	...
	return i < r ? (r = No(i, r), a = n(o, a)) : (r = No(r, i), a = n(a, o)), function(e) {
		return a(r(e));
	};
}
function Io(e, t, n) {
	var r = Math.min(e.length, t.length) - 1, i = Array(r), a = Array(r), o = -1;
	for (e[r] < e[0] && (e = e.slice().reverse(), t = t.slice().reverse()); ++o < r;) i[o] = No(e[o], e[o + 1]), a[o] = n(t[o], t[o + 1]);
	return function(t) {
		var n = ga(e, t, 1, r) - 1;
		return a[n](i[n](t));
	};
...
function Ro() {
	var e = jo, t = jo, n = Do, r, i, a, o = Mo, s, c, l;
	function u() {
		var n = Math.min(e.length, t.length);
		return o !== Mo && (o = Po(e[0], e[n - 1])), s = n > 2 ? Io : Fo, c = l = null, d;
	}
	function d(i) {
		return i == null || isNaN(i = +i) ? a : (c || (c = s(e.map(r), t, n)))(r(o(i)));
	}
	return d.invert = function(n) {
		return o(i((l || (l = s(t, e.map(r), bo)))(n)));
	}, d.domain = function(t) {
		return arguments.length ? (e = Array.from(t, Ao), u()) : e.slice();
	}, d.range = function(e) {
		return arguments.length ? (t = Array.from(e), u()) : t.slice();
	}, d.rangeRound = function(e) {
		return t = Array.from(e), n = Oo, u();
	}, d.clamp = function(e) {
		return arguments.length ? (o = e ? !0 : Mo, u()) : o !== Mo;
...
var Go = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
function Ko(e) {
	if (!(t = Go.exec(e))) throw Error("invalid format: " + e);
	var t;
	return new qo({
		fill: t[1],
		align: t[2],
...
function Xo(e, t) {
	var n = Vo(e, t);
	if (!n) return Yo = void 0, e.toPrecision(t);
	var r = n[0], i = n[1], a = i - (Yo = Math.max(-8, Math.min(8, Math.floor(i / 3))) * 3) + 1, o = r.length;
	return a === o ? r : a > o ? r + Array(a - o + 1).join("0") : a > 0 ? r.slice(0, a) + "." + r.slice(a) : "0." + Array(1 - a).join("0") + Vo(e, Math.max(0, t + a - 1))[0];
}
//#endregion
...
function ns(e) {
	var t = e.grouping === void 0 || e.thousands === void 0 ? $o : Uo(es.call(e.grouping, Number), e.thousands + ""), n = e.currency === void 0 ? "" : e.currency[0] + "", r = e.currency === void 0 ? "" : e.currency[1] + "", i = e.decimal === void 0 ? "." : e.decimal + "", a = e.numerals === void 0 ? $o : Wo(es.call(e.numerals, String)), o = e.percent === void 0 ? "%" : e.percent + "", s = e.minus === void 0 ? "−" : e.minus + "", c = e.nan === void 0 ? "NaN" : e.nan + "";
	function l(e, l) {
		e = Ko(e);
		var u = e.fill, d = e.align, f = e.sign, p = e.symbol, m = e.zero, h = e.width, g = e.comma, _ = e.precision, v = e.trim, y = e.type;
		y === "n" ? (g = !0, y = "g") : Qo[y] || (_ === void 0 && (_ = 12), v = !0, y = "g"), (m || u === "0" && d === "=") && (m = !0, u = "0", d = "=");
		var b = (l && l.prefix !== void 0 ? l.prefix : "") + (p === "$" ? n : p === "#" && /[boxX]/.test(y) ? "0" + y.toLowerCase() : ""), x = (p === "$" ? r : /[%p]/.test(y) ? o : "") + (l && l.suffix !== void 0 ? l.suffix : ""), S = Qo[y], C = /[defgprs%]/.test(y);
		...
		function w(e) {
			...
			if (y === "c") r = S(e) + r, e = "";
				...
				e = +e;
				var w = e < 0 || 1 / e < 0;
				if (e = isNaN(e) ? c : S(Math.abs(e), _), v && (e = Jo(e)), w && +e == 0 && f !== "+" && (w = !1), n = (w ? f === "(" ? f : s : f === "-" || f === "(" ? "" : f) + n, r = (y === "s" && !isNaN(e) && Yo !== void 0 ? ts[8 + Yo / 3] : "") + r + (w && f === "(" ? ")" : ""), C) {
	...
	function u(e, t) {
		var n = Math.max(-8, Math.min(8, Math.floor(Ho(t) / 3))) * 3, r = 10 ** -n, i = l((e = Ko(e), e.type = "f", e), { suffix: ts[8 + n / 3] });
		return function(e) {
			return i(r * e);
		};
	}
...
function os(e) {
	return rs = ns(e), is = rs.format, as = rs.formatPrefix, rs;
}
//#endregion
...
function cs(e, t) {
	return Math.max(0, Math.max(-8, Math.min(8, Math.floor(Ho(t) / 3))) * 3 - Ho(Math.abs(e)));
}
//#endregion
...
function us(e, t, n, r) {
	...
	switch (r = Ko(r ?? ",f"), r.type) {
		case "s":
			...
			return r.precision == null && !isNaN(a = cs(i, o)) && (r.precision = a), as(r, o);
		case "":
		case "e":
		case "g":
		case "p":
		case "r":
			r.precision == null && !isNaN(a = ls(i, Math.max(Math.abs(e), Math.abs(t)))) && (r.precision = a - (r.type === "e"));
			break;
		case "f":
		case "%":
...
function vs(e, t, n) {
	let r;
	return ys(e, t, n) && bs(e[r = +(e[0] === t[0])], n[r], t[r]);
}
function ys(e, t, n) {
...
function Ss(e) {
	let t = [], n = [];
	for (let r of e) xs(r) > 0 ? t.push([r]) : n.push(r);
	return n.forEach(function(e) {
		for (let n = 0, r = t.length, i; n < r; ++n) if (gs((i = t[n])[0], e) !== -1) {
			i.push(e);
			return;
		}
	}), t;
...
function Cs() {
	...
	function l(i) {
		c = r(i, e, t), s = Array.from(i, n), typeof o != "object" && (o = fs().domain(ps(s)).nice().ticks(o));
	}
	function* u(e) {
		l(e);
	...
	function* f(e) {
		l(e);
		let t, n, r;
		for (let e of o) n && (t = n), n = hs(g(c, s, e)), t && (yield {
			type: "MultiPolygon",
...
function Es(e, t, n, { inclusive: r = !0 } = {}) {
	if (!n || n.n === 0) return !1;
	let [i, a, o, s] = n.bbox;
...
function Ds(e, t, n) {
	let r = ws(t, n && n.eps);
	return Es(e[0], e[1], r, n);
}
function Os(e, { inclusive: t = !0, gridSize: n = 3, eps: r } = {}) {
	let i = e && e.coords ? e : ws(e, r);
	if (!i || i.n === 0) return null;
	let a = i.coords, o = i.n, [s, c, l, u] = i.bbox, d = (e, n) => Es(e, n, i, { inclusive: t }), f = (s + l) / 2, p = (c + u) / 2;
	if (d(f, p)) return [f, p];
	let m = 0, h = 0;
...
function Ps(e, t, n = 1e-6) {
	...
	let o = Ns(r);
	return !(Math.abs(o - a) / a > .02 || As(ks(r), ks(i)) < .985);
}
function Fs(e, t = []) {
	let n = Cs(), r = 0;
	t.length > 0 && (n.thresholds(t), r = t.at(-1));
	let i = Array.from(n.isobands(e)).filter((e) => Array.isArray(e.coordinates) && e.coordinates.length > 0 && (r > 0 ? e.valueMax <= r : !0)), a = Ms(e.map((e) => [e[0], e[1]]));
	if (!i || i.length === 0) {
	...
	return {
		...
		features: i.map((e, t) => {
			...
			for (let e = 0; e < i.length; e++) {
				let t = i[e], n = Os(t.ring) || t.ring[0], r = null, a = Infinity;
				for (let s = 0; s < i.length; s++) {
					if (e === s) continue;
					let c = i[s];
					c.area <= t.area || o(c.bbox, t.bbox) && Ds(n, c.ring) && c.area < a && (a = c.area, r = c);
				}
...
async function Is({ point: e, direction: t = "from", mode: n = "car", costField: r = "distance", graph: i, maxCost: a = 1e3, snapMaxDistM: o = 800, penalties: s = {} } = {}) {
...
function Vs(e) {
	...
	try {
		let t;
		if (typeof zs == "function") t = new zs();
		else if (zs && typeof zs.addEventListener == "function") t = zs;
...
}), Gs = Math.PI / 180, Ks = 6371e3;
function qs(e, t) {
	let [n, r] = e, [i, a] = t, o = (a - r) * Gs, s = (i - n) * Gs, c = r * Gs, l = a * Gs, u = Math.sin(o / 2), d = Math.sin(s / 2), f = u * u + Math.cos(c) * Math.cos(l) * d * d;
	return 2 * Ks * Math.asin(Math.sqrt(f));
}
function Js(e) {
	let t = 0;
	for (let n = 1; n < e.length; n++) t += qs(e[n - 1], e[n]);
	return t;
}
function Ys(e) {
...
async function rc(e) {
	...
	try {
		...
		try {
			...
			r = await Uc(T(n[0], n[1], 14, s, "zxy").map((t) => ({
				...t,
				url: Lc(e._urlTemplate, t, {
...
async function ic(e) {
	...
	try {
		...
		e._map.getSource(e._options.routeSourceId).setData({
			...
			properties: {}
		}), e._options.showGraph && (n.graph ? e._map.getSource(e._options.graphSourceId).setData(nc(n.graph)) : e._clearGraph());
		let r = n.coordinates;
		if (r.length > 0) {
			let t = r[0], n = r[r.length - 1];
			e._origin = t, e._dest = n, e._placeMarker("origin", t), e._placeMarker("dest", n), e._originInput.value = Xs({
				lng: t[0],
				lat: t[1]
			}), e._destInput.value = Xs({
				lng: n[0],
				lat: n[1]
			});
		}
...
function cc(e, t) {
	...
	let n = t.costField === "distance" ? t.cost : lc(t.coordinates), r = t.costField === "distance" ? $s(n, e._mode) : uc(t.cost), i = t.engine ?? "cpu", a = !!t.parallelUsed;
	e._statDistEl.textContent = Qs(n), e._statTimeEl.textContent = r, e._statDistLabelEl.textContent = e._text.stats.distance, e._statTimeLabelEl.textContent = e._costField === "distance" ? e._text.stats.estTime : e._text.stats.travelTime, e._statsEl.hidden = !1, e._engineBadgeEl.className = `rp-engine ${a ? "rp-engine--parallel" : "rp-engine--cpu"}`;
	let o = e._text.costLabels[e._costField] ?? e._text.costLabels.distance, s = ec(i);
...
var { haversineMeters: xc, getRouteDistance: Sc, parseCoords: Cc, lngLatToStr: wc, formatDuration: Tc, fmtDistance: Ec, fmtTime: Dc, formatEngineBadgeName: Oc, getEngineBadgeIcon: kc } = Bs;
function Ac(e, t) {
	let n = { ...e };
	for (let r in t) if (Object.prototype.hasOwnProperty.call(t, r)) {
		let i = t[r];
		i && typeof i == "object" && !Array.isArray(i) ? n[r] = Ac(e[r] || {}, i) : n[r] = i;
	}
	return n;
}
function jc(e, t) {
...
var Mc = class {
	constructor(e = {}) {
		...
		if (this._locale = r, this._text = n ? jc(Lr[r] ?? Lr.en, n) : Lr[r] ?? Lr.en, this._text.isoline = this._text.isoline || {}, this._text.tabs = this._text.tabs || {
	...
	setOrigin(e) {
		this._origin = [e.lng, e.lat], this._originInput.value = wc(e), this._placeMarker("origin", this._origin), this._tryRoute();
	}
	setDest(e) {
		this._dest = [e.lng, e.lat], this._destInput.value = wc(e), this._placeMarker("dest", this._dest), this._tryRoute();
	}
	setOriginFromMap(e) {
	...
	setIsoline(e) {
		this._isoline.point = [e.lng, e.lat], this._isolinePointInput && (this._isolinePointInput.value = wc(e)), this._placeIsolineMarker(this._isoline.point), this._tryIsoline();
	}
	setIsolineFromMap(e) {
	...
	_bindPanelEvents() {
		...
		i && a && (i.addEventListener("click", () => {
			...
			e && (e.hidden = !1), t && (t.hidden = !0), this._activeTab = "routing", this._clearIsoline(), $(this), dc(this, "routing");
...
function Lc(e, t, { tileUrlTransform: n, tileProxyTemplate: r } = {}) {
	let i = de(e, {
		z: t.z,
		x: t.x,
		y: t.y
...
function zc() {
	...
	Nc.clear(), Pc.clear(), Ye();
}
var Bc = zc;
function Vc(e, t, n) {
	let r = (e[1] + t[1]) / 2, i = 2 * Math.PI * 6371e3 * Math.cos(r * Ic) / 2 ** n, a = F(e, t), o = Math.max(600, a * .15);
	return Math.min(3, Math.max(1, Math.ceil(o / i)));
}
var Hc = async (e, t, n, r, { zoom: i = 14, schema: a = "zxy", radius: o, maxAutoRadius: s = 8, engineId: c = "auto", costField: l = "distance", penalties: u = {}, maxAcceptableSnapDistanceM: d, tileUrlTransform: f, tileProxyTemplate: p, includeGraph: m = !1 } = {}) => {
	if ($e(e, "start"), $e(t, "end"), n = et(n), tt(i), a = nt(a), rt(r), it(d), o !== void 0 && (o = at(o)), !Fc.has(l)) throw Error(`Unknown costField: ${l}. Expected "distance", "travelTime", or "optimal".`);
	let h = ot(u), g = o ?? Vc(e, t, i), _ = Number(s), v = Math.max(g, Math.min(10, Number.isFinite(_) ? Math.floor(_) : 8)), y = Je(), b, x = null;
	function S(e) {
		let t = 2166136261;
	...
	for (let o = g; o <= v; o++) {
		...
		let g = S(u), _ = typeof f == "function" ? null : `v3:${n}:${i}:${a}:${r}:${p ?? ""}:${g}`, T = _ ? Pc.get(_) : null;
		T || (T = await je(s, n, {
			pool: y,
			cache: Nc
		}), _ && !T?.hasMissingTiles && Pc.set(_, T)), x = T, b = await Ir(e, t, T, {
			costField: l,
			penalties: h,
			engineId: c,
		...
		}, D = Rc(T, "MissingAllowOriginHeader");
		if (!b.found && D) return {
			...b,
			...E,
			reason: "tile_cors",
...
async function Uc(e, t, { zoom: n = 14, schema: r = "zxy", urlTemplate: i = "", tileProxyTemplate: a = "", tileUrlTransform: o, pool: s = Je() } = {}) {
	...
	let u = l.toString(16), d = typeof o == "function" ? null : `v3:${t}:${n}:${r}:${i}:${a ?? ""}:${u}`, f = d ? Pc.get(d) : null;
	return f || (f = await je(e, t, {
		pool: s,
		cache: Nc
	}), d && !f?.hasMissingTiles && Pc.set(d, f)), f;
}
//#endregion
export { Mc as MapLibreRoutingControl, Pr as buildCH, Uc as buildGraphForTiles, Lc as buildTileURL, Er as cancelRunningEngine, Ir as computeRoute, zc as dispose, wr as getEngineWorkerStatus, wt as nearestNode, Tr as onEngineWorkerStatusChange, Fr as queryRoute, Hc as route, Bc as shutdown };
